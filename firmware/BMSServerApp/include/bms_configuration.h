...
#define NUM_REGISTERS 7 // Number of registers to read in a single request
...
#define CURRENT_CALIBRATION_GAIN 1000 // Calibration gain for current calculation (scaled to avoid floating-point operations)
#define CURRENT_CALIBRATION_OFFSET 0 // Calibration offset for current in milliamperes
